    ...
    public String home(
        ...
        if (sessionId != null && !sessionId.isEmpty()) {
            try {
                ...
                // This allows the inventory to be viewed without requiring login
            }
        }
    ...
    public String farmerPage(
        ...
        if (sessionId != null && !sessionId.isEmpty()) {
            try {
                ...
                // Continue without user info if authentication fails
                // This allows the farmers page to be viewed without requiring login
            }
        }
    ...
    public String addMultipleProduce(
        ...
        if (sessionId != null && !sessionId.isEmpty()) {
            try {
                ...
                // Continue without user info if authentication fails
                // This allows farmers to add produce without requiring login
            }
        }
